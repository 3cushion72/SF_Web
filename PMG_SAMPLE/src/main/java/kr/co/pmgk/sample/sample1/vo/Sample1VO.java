package kr.co.pmgk.sample.sample1.vo;

import kr.co.pmgk.base.vo.TAbstractVO;

public class Sample1VO extends TAbstractVO {
	...
	public String toString() {
		return "Sample1VO [member_id=" + member_id + ", member_name="
