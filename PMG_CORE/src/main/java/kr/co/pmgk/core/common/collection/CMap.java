package kr.co.pmgk.core.common.collection;
 ...
 *
 */
public class CMap<K,V> extends AbstractMap<K,V> implements Map<K,V>, Cloneable, Serializable {
     ...
     */
    public Object clone() {
        CMap<K,V> result = null;
	try {
	    result = (CMap<K,V>)super.clone();
    ...
    static class Entry<K,V> implements Map.Entry<K,V> {
         ...
         * in the HashMap.
         */
        void recordAccess(CMap<K,V> cMap) {
        }
         ...
         */
        void recordRemoval(CMap<K,V> cMap) {
        }
    }
    ...
    private final class KeySet extends AbstractSet<K> {
        ...
        public boolean remove(Object o) {
            return CMap.this.removeEntryForKey(o) != null;
        }
        public void clear() {
        	CMap.this.clear();
        }
