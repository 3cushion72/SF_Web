package kr.co.pmgk.base.exception;
...
/**
 * <pre>
 * Core 프로젝트의 최상위 Excepiton</br>
 * Core 프로젝트 및 Other 프로젝트의 Excepition은 클래스를 상속 받아서 구현한다.
 * </pre>
...
public class TException extends Exception {
	...
	public TException() {
		this("TException without message", null, null);
	}
	 ...
	 */
	public TException(String defaultMessage) {
	 ...
	 */
	public TException(Throwable wrappedException) {
		this("TException without message", null, wrappedException);
	}
	 ...
	 * @param wrappedException 발생한 Exception 내포함.
	 */
	public TException(String defaultMessage, Throwable wrappedException) {
	 ...
	 * @param wrappedException 발생한 Exception 내포함.
	 */
	public TException(String defaultMessage, Object[] messageParameters, Throwable wrappedException) {
	 ...
	 */
	public TException(MessageSource messageSource, String messageKey) {
	 ...
	 * @param messageKey 메세지키값
	 */
	public TException(MessageSource messageSource, String messageKey, Throwable wrappedException) {
	 ...
	 * @param wrappedException 발생한 Exception 내포함.
	 */
	public TException(MessageSource messageSource, String messageKey, Locale locale, Throwable wrappedException) {
	 ...
	 * @param wrappedException 발생한 Exception 내포함.
	 */
	public TException(MessageSource messageSource, String messageKey, Object[] messageParameters, Locale locale,
	 ...
	 * @param wrappedException 발생한 Exception 내포함.
	 */
	public TException(MessageSource messageSource, String messageKey, Object[] messageParameters,
	        Throwable wrappedException) {
